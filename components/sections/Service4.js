...
export default function Service4() {
    return (
        <>
            <section className="service-section-3 section-padding" id="service">
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                            <div className="service-box-items style-3">
                                ...
                                <div className="content">
                                    ...
                                    <p>
                                        Professional, responsive, and SEO-friendly websites tailored for businesses.
                                    </p>
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                            <div className="service-box-items style-3">
                                ...
                                <div className="content">
                                    ...
                                    <p>
                                        Cloud-based software products designed to automate and grow your business.
                                    </p>
                                    {/* <Link href="/service-details" className="theme-btn-2">
                                        read More
                                        <i className="fa-solid fa-arrow-right-long" />
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".9s">
                            <div className="service-box-items style-3 mt-70">
                                ...
                                <div className="content">
                                    ...
                                    <p>
                                        Tailor-made software applications that solve real-world business challenges.
                                    </p>
                                    {/* <Link href="/service-details" className="theme-btn-2">
                                        read More
                                        <i className="fa-solid fa-arrow-right-long" />
